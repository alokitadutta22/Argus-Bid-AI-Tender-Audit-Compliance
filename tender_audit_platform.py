        ...
        <div id="custom-argus-loader" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: #0B1220; z-index: 9999999; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: 'Inter', sans-serif; transition: opacity 0.4s ease-out, visibility 0.4s ease-out; overflow: hidden;">
            ...
            <div style="position: relative; z-index: 1; display: flex; flex-direction: column; align-items: center;">
                ...
                <p style="color: #94A3B8; margin: 0; font-size: 13px; font-family: monospace; letter-spacing: 1px; text-transform: uppercase;">
                    <span style="color: #38BDF8; margin-right: 8px;">></span> <span class="typing-text">Initializing engine...</span>
                </p>
            </div>
            <style>
...
def render_landing_page() -> None:
    ...
    <div class="landing-navbar" id="top">
        ...
        <div class="nav-links" style="display: flex; align-items: center; gap: 10px; font-size: 12.5px;">
            ...
            <a href="#sec-07" target="_self" style="text-decoration: none; color: inherit;"><svg style="display: none;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>Types</a>
